...
- Priority-based tagging (e.g., _High_, _Compliance Required_)
...
# Then create a database manually (example):

psql -U postgres
CREATE DATABASE kmrl_insight_vault;
\q

# (Optional) Test DB connection
npm run db:connect   # if you have a script, or just start server to auto-sync

# 4. Sync database tables using Sequelize
# This will automatically create tables from models
npm run dev          # starts backend and runs sequelize.sync()
